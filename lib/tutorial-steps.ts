 ...
 */
function getCommunityStep(whatsappGroupLink?: string, whatsappChannelLink?: string): DriveStep {
  const groupLink = whatsappGroupLink || "https://chat.whatsapp.com/FC6jYV3VDEQ4MmdTXiFqDV";
  const channelLink = whatsappChannelLink || "https://whatsapp.com/channel/0029Vb7HTfx47XeIZz7ht232";
  return {
 ...
 */
export function getDashboardTutorialSteps(userRole: UserRole, whatsappGroupLink?: string, whatsappChannelLink?: string): DriveStep[] {
  ...
  if (userRole === 'agent') {
    steps.push({
      ...
      popover: {
        ...
        description: `
          <div>
            <p>Place multiple orders at once! Great for serving multiple users efficiently.</p>
  ...
  steps.push(getCommunityStep(whatsappGroupLink, whatsappChannelLink));
 ...
 */
export function getOrderHistoryTutorialSteps(whatsappGroupLink?: string, whatsappChannelLink?: string): DriveStep[] {
  return [
    {
    ...
    // Community
    getCommunityStep(whatsappGroupLink, whatsappChannelLink),
    // Completion
    {
      popover: {
 ...
 */
export function getComplaintsTutorialSteps(whatsappGroupLink?: string, whatsappChannelLink?: string): DriveStep[] {
  return [
    // Welcome
    {
      popover: {
 ...
 */
export function getProfileTutorialSteps(whatsappGroupLink?: string, whatsappChannelLink?: string): DriveStep[] {
  return [
    // Welcome
    {
      popover: {
...
/**
 * Upgrade Page Tutorial Steps (User only)
 */
export function getUpgradeTutorialSteps(whatsappGroupLink?: string, whatsappChannelLink?: string): DriveStep[] {
  return [
    // Welcome
    {
      popover: {
 ...
 */
export function getWalletTutorialSteps(userRole: UserRole, whatsappGroupLink?: string, whatsappChannelLink?: string): DriveStep[] {
  const steps: DriveStep[] = [
    // Welcome
    {
      popover: {
 ...
 */
export function getDataPackagesTutorialSteps(userRole: UserRole, whatsappGroupLink?: string, whatsappChannelLink?: string): DriveStep[] {
  const steps: DriveStep[] = [
    // Welcome
    {
      popover: {
