...
export function WhatsAppCommunityButtons({ className, compact = false }: { className?: string, compact?: boolean }) {
    ...
    const GROUP_LINK = settings.whatsappGroupLink || "https://chat.whatsapp.com/FC6jYV3VDEQ4MmdTXiFqDV?mode=gi_t"
    const CHANNEL_LINK = settings.whatsappChannelLink || "https://whatsapp.com/channel/0029Vb7HTfx47XeIZz7ht232"
