...
export function AgentExpiryModal() {
    ...
    // Check if user WAS an agent (now user) with expired date
    // This happens after auto-downgrade in AuthContext
    const wasAgent = dbUser?.role === 'user' &&
            ...
            <DialogContent className="sm:max-w-[500px]" onInteractOutside={(e) => e.preventDefault()}>
                <DialogHeader>
                    ...
                    <DialogDescription className="text-base">
                        Your agent membership has expired. You have been automatically downgraded to user role.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-6 py-4">
                    ...
                    <p className="text-xs text-center text-muted-foreground">
                        Your account has been automatically downgraded to user role. You can upgrade back to agent anytime.
                    </p>
                </div>
            </DialogContent>
        </Dialog>
